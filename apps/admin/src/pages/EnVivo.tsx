...
/** Cada cuánto se refresca la foto. */
 ...
 * vender, qué se pide más hoy, y si las impresoras respiran. Se refresca
 * sola cada 10 segundos.
 */
        ...
        action={
          panel && (
            <div className="flex items-center gap-2 bg-white border border-sa-green-ink/10 rounded-full px-4 py-2 shadow-sa-sm">
              <span className="w-2 h-2 rounded-full bg-sa-mint animate-pulse" />
              <span className="text-sm font-mono text-sa-green-ink">{panel.ahora}</span>
            </div>
          )
        }
      />
        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <Kpi
              ...
              sub={panel.corte ? `${panel.corte.abrio ?? 'sin registro'} · fondo ${mxn(panel.corte.fondo)}` : 'Nadie ha abierto turno'}
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            {/* Últimos pedidos */}
            <div className="bg-white rounded-sa p-5 shadow-sa-sm border border-sa-green-ink/5">
              <h3 className="font-display text-xl text-sa-green-ink mb-4">Últimos pedidos</h3>
